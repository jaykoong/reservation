...
<div class="row row-offcanvas row-offcanvas-right">
		<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
		   ...
		   <div class="panel panel-inverse">
			 ...
			 <div class="panel-heading">จองห้อง</div>
						   ...
						   <form  method="POST" action="#.php">
								<div class="col-xs-12 col-sm-12">
					            	...
					            	<div class="form-group">
					            		<div class="row">
					            			<div class="col-xs-12 col-sm-12">
					            				<label class="control-label" for="from">เช็คอิน</label>
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
					            				<label class="control-label" for="to">เช็คเอาต์</label>
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
						           				 <button type="submit" class="btn btn-inverse" align="right"name="avail">ตรวจสอบห้องว่าง</button>
						           			 </div>
						            	</div>
						            </div>
						        </div>
